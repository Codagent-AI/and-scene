...
export function Stage<TPayload>({ step, index, mode, onTouchStart, onTouchEnd }: StageProps<TPayload>) {
  ...
  return <section ref={setStage} className="presentation-stage" data-presentation-stage onTouchStart={onTouchStart} onTouchEnd={onTouchEnd} style={{ display: 'grid', minHeight: 0, minWidth: 0, overflow: 'hidden', placeItems: 'center' }}>
