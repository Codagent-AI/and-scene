...
export function Footer<T>({ title, step, index, steps, mode, onSelect, onNext, onPrev }: { title: string; step: Step<T>; index: number; steps: readonly Step<T>[]; mode: PresentationMode; onSelect: (index: number) => void; onNext: () => void; onPrev: () => void }) {
