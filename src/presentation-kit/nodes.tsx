...
export function Appear({ children, className, style }: { children: ReactNode; className?: string; style?: CSSProperties }) { return <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: ENTER_T, delay: 0.58 }} className={className} style={style} data-presentation-appear="">{children}</motion.div> }
