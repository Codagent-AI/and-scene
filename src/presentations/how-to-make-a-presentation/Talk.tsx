...
import { Scene, type SamplePayload } from './Scene'
...
const steps: Step<SamplePayload>[] = outline.map(([era, title, caption], index) => ({
  id: `step-${index + 1}`, era, title, caption, Scene, payload: { index }, groupKey: 'the-growing-scene',
}))
