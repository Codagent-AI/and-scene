...
describe('How to Use This Skill to Make a Presentation', () => {
  test('implements the canonical nine-step reference outline in order', () => {
    ...
    expect(STEPS.every((step) => step.groupKey === 'how-to-make-a-presentation')).toBe(true)
  })
})
