...
import { ReferenceScene, type ReferencePayload } from './steps/Scene'
...
export const steps: Step<ReferencePayload>[] = outline.map(([era, title, caption], index) => ({
  id: `how-to-make-a-presentation-${index + 1}`,
  era,
  title,
  caption,
  groupKey: 'how-to-make-a-presentation-evolving-scene',
  payload: { through: index },
