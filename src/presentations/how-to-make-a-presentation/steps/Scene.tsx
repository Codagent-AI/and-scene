  ...
  return (
    <SceneLayer className="sample-scene">
      ...
      {stage >= 2 && <div className="tray" data-allow-overlap>
        {cards.slice(0, Math.min(cards.length, Math.max(1, stage - 2))).map(([number, ...parts], index) => (
      ...
      {stage >= 5 && <div className="depth-control"><Emphasis id="sample-depth-label">partial</Emphasis><Arrow id="sample-depth-arrow" className="arrow">↔</Arrow><Emphasis id="sample-full-label">full</Emphasis></div>}
