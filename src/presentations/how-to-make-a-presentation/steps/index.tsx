...
export const REFERENCE_STEPS: Step<ReferencePayload>[] = outline.map((beat, index) => ({ id: `reference-${index + 1}`, ...beat, groupKey: 'reference-scene', Scene: EvolvingScene, payload: { through: index + 1 } }))
