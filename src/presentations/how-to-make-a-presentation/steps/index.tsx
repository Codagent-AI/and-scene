...
export const STEPS: readonly Step<{ beat: number }>[] = outline.map(([section, title, caption], index) => ({
  id: `step-${index + 1}`, section, title, caption, Scene, payload: { beat: index }, groupKey: 'how-to-make-a-presentation',
}))
