...
export function StoryScene({payload:{beat}}:SceneProps<StoryPayload>){const show=(n:number)=>beat>=n;const cardCount=beat<2?0:beat===2?1:cards.length
 return <SceneLayer className="howto-scene">
  ...
  {show(8)&&<div key="reveal" className="howto-reveal" data-presentation-allow-overlap=""><Frame entityId="howto-frame" className="howto-frame"><span>THIS PRESENTATION IS ONE</span></Frame></div>}
 </SceneLayer>
}
